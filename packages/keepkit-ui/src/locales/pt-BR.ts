...
export const PT_BR_LABELS: KeepUiLocaleLabels = {
  ...
  filterCollections: "Filtrar por coleção",
  ...
  resetFilters: "Redefinir filtros iniciais",
  ...
  activityNeverOpened: "Nunca aberto",
  activityOpened: "Aberto",
  activityInactiveFor: "dias inativo",
  activityInactiveSuffix: "inativo",
  activityBefore: "Aberto antes de",
  activityAfter: "Aberto depois de",
  undoReorder: "Desfazer reordenação",
  toolbarStart: "Ações da coleção",
  toolbarQuery: "Pesquisar e ordenar",
  toolbarFilters: "Filtros",
  toolbarEnd: "Ações adicionais",
