...
export const TH_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "รีเซ็ตเป็นตัวกรองเริ่มต้น",
  removeFilter: "นำออก",
  ...
  activityNeverOpened: "ยังไม่เคยเปิด",
  activityOpened: "เคยเปิดแล้ว",
  activityInactiveFor: "วันที่ไม่มีการใช้งาน",
  activityInactiveSuffix: "ไม่มีการใช้งาน",
  activityBefore: "เปิดก่อน",
  activityAfter: "เปิดหลัง",
