...
export const DE_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "Auf Anfangsfilter zurücksetzen",
  ...
  activityNeverOpened: "Noch nie geöffnet",
  activityOpened: "Geöffnet",
  activityInactiveFor: "Tage inaktiv",
  activityInactiveSuffix: "inaktiv",
  activityBefore: "Geöffnet vor",
  activityAfter: "Geöffnet nach",
