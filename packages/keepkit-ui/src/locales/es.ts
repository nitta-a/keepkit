...
export const ES_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "Restablecer filtros iniciales",
  removeFilter: "quitar",
  ...
  activityNeverOpened: "Nunca abierto",
  activityOpened: "Abierto",
  activityInactiveFor: "días inactivo",
  activityInactiveSuffix: "inactivo",
  activityBefore: "Abierto antes de",
  activityAfter: "Abierto después de",
  undoReorder: "Deshacer ordenación",
  toolbarStart: "Acciones de la colección",
