...
export const EN_LABELS: KeepUiLocaleLabels = {
  ...
  activityNeverOpened: "Never opened",
  activityOpened: "Opened",
  activityInactiveFor: "days inactive",
  activityInactiveSuffix: "inactive",
  activityBefore: "Opened before",
  activityAfter: "Opened after",
