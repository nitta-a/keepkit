...
export const FIL_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "Ibalik sa mga unang filter",
  removeFilter: "alisin",
  ...
  activityNeverOpened: "Hindi pa nabubuksan",
  activityOpened: "Nabuksan",
  activityInactiveFor: "araw na hindi aktibo",
  activityInactiveSuffix: "hindi aktibo",
  activityBefore: "Nabuksan bago",
  activityAfter: "Nabuksan pagkatapos",
