...
export const RU_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "Сбросить к исходным фильтрам",
  ...
  activityNeverOpened: "Не открывался",
  activityOpened: "Открывался",
  activityInactiveFor: "дн. без активности",
  activityInactiveSuffix: "без активности",
  activityBefore: "Открыт до",
  activityAfter: "Открыт после",
