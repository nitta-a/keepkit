...
export const MS_LABELS: KeepUiLocaleLabels = {
  ...
  resetFilters: "Tetapkan semula penapis awal",
  ...
  activityNeverOpened: "Belum pernah dibuka",
  activityOpened: "Telah dibuka",
  activityInactiveFor: "hari tidak aktif",
  activityInactiveSuffix: "tidak aktif",
  activityBefore: "Dibuka sebelum",
  activityAfter: "Dibuka selepas",
